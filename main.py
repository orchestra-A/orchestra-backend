...
# =====================================================================
# Route 9 — Manual Task Status Update
# =====================================================================
# Allows manual task status updates for testing.
# Also useful for Member 6's UI to update tasks directly.
...
async def update_task(task_id: str, request: Request):
    ...
    # Extract number from task_id
    # Accepts both "task_008" and "8" formats
    task_ref = task_id.replace("task_", "").lstrip("0") or "0"
    success = update_task_status(task_ref, new_status)

    if success:
        return {
            "updated": True,
            "task_id": f"task_{task_ref.zfill(3)}",
...
# =====================================================================
# Route 11 — GitHub OAuth Callback
# =====================================================================
# GitHub redirects here after user approves access.
# We exchange the temporary "code" for a real access token.
...
async def github_callback(code: str):
    async with httpx.AsyncClient() as client:
        ...
        # Step 2 — Use token to get user's GitHub profile
